...
def train(datadir, logdir, input_size, num_of_classes, batch_size, weights, epoch, pre_trained_model):
    
    if classes=='Srinivasan2014':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes', type=str, help='Choosing between 2 OCT datasets', choices=['Srinivasan2014','Kermany2018'])
    ...
    train(args.datadir, args.logdir, args.input_dim, args.classes, args.batch, args.weights, args.epoch, args.model)